...
class Model(nn.Module):
    def __init__(self):
        ...
        self.layer201 = nn.Sequential(nn.Linear(262, 11, bias=True))

    def forward(self, input_img, pickle_feats):
        ...
        pickle_feats1 = pickle_feats[:,:,0]
        pickle_feats2 = pickle_feats[:,:,1]

        df4 = torch.cat((df4, pickle_feats1, pickle_feats2),1)
